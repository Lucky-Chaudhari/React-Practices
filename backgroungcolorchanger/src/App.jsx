  ...
  return (
   <div className="w-full h-screen duration-200  "style={{ backgroundColor: color}}>
    <div className='fixed flex flex-wrap justify-center bottom-12 inset-x-0 px-2'>
     ...
     {/* onclick event ko function chahiye function se jo return aarha hai wo nahi chahiye usko   isliye hum dirct function call nahi karte ahe */}
      ...
      <button onClick={()=> setColor ("pink")}  className="outline-none px-4 py-1 rounded-full text-black shadow-lg"style={{backgroundColor:"lavender"}} >Lavender</button>
